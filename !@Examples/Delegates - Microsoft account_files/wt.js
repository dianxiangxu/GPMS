...
// Created: 10/21/2009
//Modified:02/04/11:bka:commented out several variables to save space
...
WebTrends.prototype.dcsVar = function () {
    ...
    //Modified:02/04/11:bka:removed to save space since wtEvtSrc already exists
    ...
    if ((window.document.referrer != "") && (window.document.referrer != "-")) {
        if (!(navigator.appName == "Microsoft Internet Explorer" && parseInt(navigator.appVersion) < 4)) {
            ...
            WT.z_referrer = window.document.referrer;
        }
    }
}
...
WebTrends.prototype.dcsMSVar = function () {
    ...
    //Modified:02/04/11:bka:removed to save space since variables are not being used
...
WebTrends.prototype.dcsMSLocaleScrape = function () {
    ...
    var fromURL = this.dcsMSLocaleFromString(unescape(this.DCS.dcsuri));
            ...
            while (b != 1) {
                if (n.tagName && n.tagName == "body") {
                    ...
                    if (n.className) {
                        ...
                        for (var c = 0; c < e.length; c++) for (var d = 0; d < f.length; d++) if (f[d] == e[c] && f[d] != "") {
                            b = 1;
                            return true
                        }
                    }

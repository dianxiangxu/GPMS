...
//        return i.data("jslider") || i.data("jslider", new r(t, n)), i.data("jslider")
        return i.data("jslider", new r(t, n)), i.data("jslider")
    ...
    r.prototype.init = function (t, r) {
        ...
        this._parent = {offset: this.parent.domNode.offset(), width: this.parent.domNode.width()}, this.ptr.addDependClass("hover"), this.setIndexOver()
            , jQuery('.price_header.migration_check .calculator table').addClass('glow')
        ...
        this.parent.settings.callback && e.isFunction(this.parent.settings.callback) && this.parent.settings.callback.call(this.parent, this.parent.getValue()), this.ptr.removeDependClass("hover")
            , jQuery('.price_header.migration_check .calculator table').removeClass('glow')

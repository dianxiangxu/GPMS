...
var s_account; //
//var s_account="avon-us-shop-dev"

var myLocIs = location.hostname;
(myLocIs == "www.avon.com") ? s_account="avon-us-shop-prod" : s_account="avon-us-shop-dev";
...
s.linkInternalFilters = "javascript:,avon.com"
...
function s_doPlugins(s) {
  ...
  /*get Query Params */
s.eVar36=s.getQueryParam('om_rid');
s.eVar37=s.getQueryParam('om_mid'); 
  
	/*New vs Repeat */
	s.eVar14 = s.prop13 = s.getNewRepeat(30, 's_getNewRepeat');
	...
	/*Get Previous Values */
	//s.eVar23 = s.getPreviousValue(s.pageName, 'gpv_pn', '');
  
//if(s.events.indexOf('scCheckout')>-1)
//s.prop28='start';
//if(s.events.indexOf('purchase')>-1)
//s.prop28='stop';
//s.prop28=s.getTimeToComplete(s.prop28,'ttc_c28',0);  

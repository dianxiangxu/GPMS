!function (a) {
	"object" != typeof a.joms && (a.joms = {}),
	a.joms.DEBUG = !1,
	a.joms.log = a.joms.info = a.joms.warn = function () {},
	a.joms_cache_$LAB = a.$LAB,
	a.joms_cache_Hammer = a.Hammer
}
(this), function (a) {
	function b(a) {
	...
	function i(a, b, c, d, e) {
		setTimeout(function () {
			...
			e ? w ? (c.elem = f, v ? (f.preload = !0, f.onpreload = d) : f.onreadystatechange = function () {
					...
					for (var f = 0; f < arguments.length; f++)
						!function (f, g) {
							...
							for (var n = 0; n < g.length; n++)
								h(), f = g[n], b(f) && (f = f()), f && (c(f) ? (l = [].slice.call(f), l.unshift(n, 1), [].splice.apply(g, l), n--) : ("string" == typeof f && (f = {
												src : f
											}), f = e(f, {
												ready : !1,
												ready_cb : a,
		...
		u = {
			...
			runQueue : function () {
				for (var a, b = u, c = z.length, d = c; --d >= 0; )
					a = z.shift(), b = b[a.type].apply(null, a.args);
				return b
			},
			noConflict : function () {
				return a.$LAB = k,
...
(this), function (a, b) {
	function c() {
		...
		a.joms.$LAB.script(function () {
			...
			a.joms_init_postbox(),
			a.joms.misc.view.fixSVG()
		})
	}
	function d() {
		a.joms.jQuery = a.jQuery,
		a.joms.loadCSS = a.loadCSS,
		a.joms.Hammer = a.Hammer,
		a.Hammer = a.joms_cache_Hammer,
		delete a.joms_cache_Hammer,
		a.joms._ = a._,
		a.joms.Backbone = a.Backbone.noConflict(),
		a.joms.Backbone.$ = a.joms.jQuery
	}
	a.joms.$LAB = a.$LAB,
	a.$LAB = a.joms_cache_$LAB,
	delete a.joms_cache_$LAB,
	a.joms.jQuery = b,
	a.joms.Hammer = b,
	a.joms._ = b,
	a.joms.Backbone = b,
	a.joms.onAjaxReponse = function (b, c) {
		a.joms._onAjaxReponseQueue || (a.joms._onAjaxReponseQueue = []),
		a.joms._onAjaxReponseQueue[b] || (a.joms._onAjaxReponseQueue[b] = []),
		a.joms._onAjaxReponseQueue[b].push(c)
	},
	a.joms.onStart = function (c) {
		a.joms._onStartQueue === b && (a.joms._onStartQueue = []),
		a.joms._onStartStarted ? c(a.joms.jQuery) : a.joms._onStartQueue.push(c)
	},
	a.joms.start = function () {
		if (a.joms_queue && a.joms_queue.length && (a.joms._onStartQueue === b && (a.joms._onStartQueue = []), a.joms._onStartQueue = a.joms_queue.concat(a.joms._onStartQueue), a.joms_queue = []), a.joms._onStartQueue !== b)
			for (; a.joms._onStartQueue.length; )
				try {
	...
	a.joms.fixUI = function () {
		...
		b,
		c,
		d = document.getElementsByClassName("joms-module__wrapper"),
		e = document.getElementsByClassName("joms-module__wrapper--stacked");
		for (c = d.length - 1; c >= 0; c--)
			d[c].innerHTML.match(/joms-tab__content/) || d[c].parentNode.removeChild(d[c]);
		for (c = e.length - 1; c >= 0; c--)
			e[c].innerHTML.match(/joms-module--stacked/) || e[c].parentNode.removeChild(e[c]);
		a = document.getElementsByClassName("joms-sidebar")[0],
		a && !a.innerHTML.match(/joms-module|app-position/) && (b = document.getElementsByClassName("joms-main")[0], a.parentNode.removeChild(a), b && (b.className += " joms-main--full"))
	};
	var e = "source/js/",
	f = "release/js/",
	g = "vendors/",

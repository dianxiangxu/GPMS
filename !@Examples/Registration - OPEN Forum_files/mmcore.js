...
//transport
	...
	_rt:1000,
//private
	jsver:'5.14.1',_vars:{fv:{},act:{},uat:{},ids:{}},_act_id:0,_vars_alias:{act:'uv'},_renderers:{},_extensions:{},_r_mbs:{},
	...
	_Init:function(first){
		...
		if (!vcb_url){
				...
				if(rx.test(vcb_url)){_t.SetCookie('mmVcbInitScriptUrl',vcb_url,1,false);}}
		}
		vcb_url=_t.GetCookie('mmVcbInitScriptUrl');if(rx.test(vcb_url))_t._InitVcb(vcb_url,cid);
	},
	_Clear:function(){var v=this._vars;v.mb={};v.act={};v.uat={}}
};

if (location.hostname.indexOf('americanexpress.com')+1) mmcore.cookie_domain = '.americanexpress.com'; // add cookie domain for americanexpress.com

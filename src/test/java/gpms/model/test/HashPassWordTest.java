...
/**
 * 
 * This is created to test the open sourced hashing tool I found.  
 * Let's see if it can create a hashed and salted password as well as retrieve it.
 * 
 * @author Thomas Volz
 * 
 *
...
public class HashPassWordTest 
{
	...
	public static void main (String args[]) throws NoSuchAlgorithmException, InvalidKeySpecException 
	{
		...
		System.out.println("Welcome to the system, we are registering you as a user:");
		
		System.out.println("You have been registered as userOne.\n  Please enter a password: ");
		firstPassword = keyb.nextLine();
		
		
		UserAccount newUser = new UserAccount("userOne", firstPassword);
		...
		//This of course is not the password as it is stored in the system, which is hashed.
		//Just what was originally typed in for ease of remembering and comparison.
		...
		assertTrue(PasswordHash.validatePassword(secondPassword, newUser.getPassword()));
	}

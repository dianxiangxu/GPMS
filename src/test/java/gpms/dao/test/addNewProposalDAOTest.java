...
public class addNewProposalDAOTest {
	...
	public void setProjectInformation()
	{
		...
		//current time + days till its due * hours in a day * minutes in a hour * seconds in a minute * millisecound in a second
	...
	public void setSponsorAndBudgetInfo()
	{
		...
		assertTrue(sponAndBudg.getTotalCosts() == sponAndBudg.getDirectCosts() + sponAndBudg.getFACosts());

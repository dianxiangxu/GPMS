...
public class ProposalDAO extends BasicDAO<Proposal, String> {
	...
	// Datastore ds = getDatastore();
	// return
	// ds.createQuery(Proposal.class).field("project info.project type.research-applied").equal(true).asList();
	// }
	...
	// }
	//
	// public void addCoPiList(Proposal proposal, ArrayList<UserProfile>
	// coPiList) throws UnknownHostException, MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	...
	// }
	//
	// public void addCoPi(Proposal proposal, UserProfile coPi) throws
	...
	// }
	//
	// public void updateCoPi(Proposal proposal, int coPiIndex, UserProfile
	// CoPi) throws UnknownHostException, MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	...
	// }
	//
	// public void removeCoPi(Proposal proposal, int coPiIndex) throws
	// UnknownHostException, MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	...
	// }
	//
	// public void removeAllCoPi(Proposal proposal) throws UnknownHostException,
	// MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	...
	// }
	//
	// public void addSeniorPersonelList(Proposal proposal,
	// ArrayList<UserProfile> seniorPersonnelList) throws UnknownHostException,
	// MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	...
	// }
	//
	// public void addSeniorPersonel(Proposal proposal, UserProfile
	// seniorPersonnel) throws UnknownHostException, MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	...
	// }
	//
	// public void updateSeniorPersonnel(Proposal proposal, int
	// seniorPersonnelIndex, UserProfile seniorPersonnel) throws
	// UnknownHostException, MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	...
	// }
	//
	// public void removeSeniorPersonnel(Proposal proposal, int
	// seniorPersonnelIndex) throws UnknownHostException, MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	// ArrayList<UserProfile> seniorPersonnelList = invInf.getSeniorPersonnel();
	...
	// }
	//
	// public void removeAllSeniorPersonnel(Proposal proposal) throws
	// UnknownHostException, MongoException
	// {
	// Datastore ds = getDatastore();
	// InvestigatorInfo invInf = proposal.getInvestigatorInfo();
	...
	public Proposal proposalByPiId(ObjectId piId) throws UnknownHostException {
		Datastore ds = getDatastore();
		return ds.createQuery(Proposal.class).field("investigator info.PI.$id")
				.equal(piId).get();
	}

...
public class FriendsandFollowersService {
	...
	// public String getAllPendingIncomingRequests(@QueryParam("uid") int
	// userID)
	// throws Exception {
	...
	// @Produces("application/json")
	// public String getAllPendingOutgoingRequests(@QueryParam("uid") int
	// userID)
	// throws Exception {
	...
	// // user specified in the ID parameter. Returns the befriended users id
	// when
	// // successful. Returns a string describing the failure condition when
	// // unsuccessful. If you are already friends with the user a HTTP 403 may
	// be
	// // returned
	// @POST
	...
	// the
	// // user specified in the ID parameter. Returns the unfollowed user�s id
	// when
	// // successful. Returns a string describing the failure condition when
	// // unsuccessful.
	// @POST
	...
	// }
	//
	// // GET friends/list Returns a cursored collection of user ids for every
	// user
	// // the specified user is following.
	// @GET
	// @Path("/GetAllFriends")
	// @Produces("application/json")
	// public String getAllFriends(@QueryParam("uid") int userID) throws
	// Exception {
	...
	// throws Exception {
	// ArrayList<FollowersObjects> followerList = new
	// ArrayList<FollowersObjects>();

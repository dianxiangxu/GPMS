...
public class ProposalService {
	...
	public String produceProposalDetailsByProposalId(String message)
		...
		// proposal.getInvestigatorInfo().getPi();
		//
		// if (PI.getUserRef().getDetails() == null) {
		// proposal.getInvestigatorInfo().setPi(null);
		// }
		//
		// for (Iterator<InvestigatorRefAndPosition> it = proposal
		// .getInvestigatorInfo().getCo_pi().iterator(); it.hasNext();) {
		// InvestigatorRefAndPosition p = it.next();
		// if (p.getUserRef().getDetails() == null) {
		// it.remove();
		// }
		// }
		//
		// for (Iterator<InvestigatorRefAndPosition> it = proposal
		// .getInvestigatorInfo().getSeniorPersonnel().iterator(); it
		// .hasNext();) {
		// InvestigatorRefAndPosition p = it.next();
		// if (p.getUserRef().getDetails() == null) {
		// it.remove();
	...
	public String saveUpdateProposal(String message)
		...
		/**
		 * TODO Setup the hashmap properties It should be a String key that
		 * mapes to another hashmap, with a key pointing to an array of strings
		 */
		HashMap<String, Multimap<String, String>> attrMap = new HashMap<String, Multimap<String, String>>();
		// HashMap AttributesMap = new HashMap<String, HashMap<String,
		// String[]>>();

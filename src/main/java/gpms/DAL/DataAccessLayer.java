...
public class DataAccessLayer {
	...
	// throws Exception {
	// ArrayList<FriendsObjects> incomingFriendList = new
	...
	// throws Exception {
	// ArrayList<FriendsObjects> outgoingFriendList = new
	// ArrayList<FriendsObjects>();
	// try {
	// PreparedStatement ps = connection
	...
	// }
	//
	// public String sendFriendRequest(int userID, int friend_id) throws
	// Exception {
	//
	...
	// if ((userVO.get_friendto_uid() == userID && userVO.get_uid() ==
	// friend_id)
